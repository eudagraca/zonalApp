...
class SoldProductsActivity : AppCompatActivity(), KodeinAware, OnRecyclerViewClickListener {
    ...
    private fun List<Product>.toProductItem(): List<ProductItem> {
        return this.map {
            ProductItem(it, Session(baseContext), this@SoldProductsActivity)
        }
    }
